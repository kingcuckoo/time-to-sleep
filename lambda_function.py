...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome, What time would you like to wake up before?"
...
class SleepIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "That doesn't seem like a valid time"
        ...
        if result:
            ...
            handler_input.response_builder
                .speak(speak_output)
                .ask("What time would you like to wake up before?")
                .response  
                )
        ...
        speak_output = "Ok I'll set an alarm for "+time
...
class HelloWorldIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "Hi, What time would you like to wake up before?"
